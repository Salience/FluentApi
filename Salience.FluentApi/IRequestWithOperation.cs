...
namespace Salience.FluentApi
{
    public interface IRequestWithOperation
    {
        ...
        /// <summary>
        /// Indicates that the specified resource shall be accessed with the PATCH method.
        /// </summary>
        /// <param name="resourcePath">The resource to access</param>
        /// <returns>This request</returns>
        IRequestWithMethod Patch(string resourcePath);
        ...
        /// <param name="requestCustomizer">A method to customize the RestSharp request</param>
        /// <returns>This request</returns>
        IRequestWithMethod Patch(string resourcePath, Action<RestRequest> requestCustomizer);
